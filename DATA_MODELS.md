...
**Explanation:** Every entity in the system belongs to exactly one organization. This table is the root of all data. Deleting an organization cascades to all child records.
...
| org_id      | uuid         | FK → organization(id), NOT NULL | Parent organization               |
| source      | varchar(50)  | NOT NULL           | Origin of event: email, api, webhook     |
